...
- расширить `query.SourceRef` alias/table информацией;
- внедрять predicate в SQL на уровне compiler/translator;
- отдельно проверить JOIN, авто-join ссылок, виртуальные таблицы регистров,
  группировки и подзапросы;
