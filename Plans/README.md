...
> Сверка от 2026-06-19: планы **59** (компоновка отчётов), **66** (страницы),
> **67** (`ВыполнитьКоманду`) — реализованы; **68** (СКД v2) — этапы A+B, C1 (pivot)
> и C2 (варианты компоновки) готовы, C3 (рантайм-настройки) вынесен в план **70**.
