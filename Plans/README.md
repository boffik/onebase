...
> готовы, C3 (рантайм-настройки) вынесен в план **70**.
...
| 68 | [68-report-composition-v2.md](68-report-composition-v2.md) | СКД v2 — развитие компоновки: сворачивание, выравнивание/формат, экспорт в Excel, вычисляемые показатели, расшифровка в документ, pivot, варианты компоновки | 1.5–2 недели | 🟡 Этапы A (UX), B (Excel/вычисляемые/расшифровка), C1 (pivot) и C2 (варианты компоновки) готовы; C3 (рантайм-настройки) вынесен в план 70 |
| 70 | [70-report-runtime-settings.md](70-report-runtime-settings.md) | СКД C3 — рантайм-настройки отчёта пользователем: панель группировок/показателей/отборов на форме отчёта, сохранение per-user в `_settings` | 1.5–2 недели | ⬜ Не начато (план готов) |
...
| 31 | [31-equipment-in-main-ui.md](31-equipment-in-main-ui.md) | Оборудование в основном UI (браузер→агент, SSE в формах) | 3–4 дня | ⬜ Не начато |
| 32 | [32-declarative-display.md](32-declarative-display.md) | Декларативный дисплей + CP866-кодировка | 2 дня | ⬜ Не начато |
