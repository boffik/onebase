...
| № | Файл | Фича | Эстимейт | Статус |
|---|---|---|---|---|
| 48 | [48-llm-business-assistant.md](48-llm-business-assistant.md) | ИИ-помощник (LLM): мультипровайдер с маршрутизацией по задачам, builtin `ЗапросИИ`, чат в UI, помощник в конфигураторе, умная загрузка документов (vision) | 3–4 недели (мин. срез F1+F2 ≈ 5–8 дней) | 🟡 F1 (ядро+настройки), F2 (builtin), F3 (чат) и F4 (tool-use по данным) реализованы; F5–F6 — нет |
