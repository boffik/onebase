...
- следующим срезом очищена обычная `page-form`: popup cancel, dropdown toggle,
  ...
  handlers;
- оставшийся долг — inline handlers в отчётах, регистрах, журналах,
  query/dev tools и админках. Их нужно выносить отдельными PR через явный
