...
Onebase DSL — 1С-подобный язык для написания бизнес-логики. Файлы `.os` в папке `src/`.
...
Отчёты поддерживают графики через ECharts. Диаграмма создаётся программно в DSL — аналогично 1С.
