...
// План 37, этап 2: реализован только convert-from-1c. Остальные подкоманды
// (convert-to-1c, validate, init) добавятся на следующих этапах.
...
форму из выгрузки конфигурации Enterprise-системы и (на следующих этапах
плана 37) экспортирует обратно.
