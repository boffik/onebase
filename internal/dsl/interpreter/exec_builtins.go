...
// базы exec.enabled (как предохранитель сети, план 62), а недоверенный код
// дополнительно отсекается профилем песочницы (DenyExec). Команда и аргументы
// передаются РАЗДЕЛЬНО (exec.CommandContext, без
