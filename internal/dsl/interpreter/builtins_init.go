...
func init() {
	...
	// ПустаяСсылка(x) — узкий предикат именно для ссылок (см.
	...
	// с правильным склонением рубль/рубля/рублей и копейки (
	...
	// с гарантией суммы ( Веса — Массив чисел; результат — Массив
