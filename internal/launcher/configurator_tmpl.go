...
<div id="cfggen-panel" style="display:none;position:fixed;right:18px;bottom:18px;z-index:9001;width:920px;max-width:calc(100vw - 24px);height:640px;max-height:calc(100vh - 40px);background:#fff;border:1px solid #cbd5e1;border-radius:12px;box-shadow:0 8px 32px rgba(0,0,0,.22);flex-direction:column;overflow:hidden;font-family:system-ui,sans-serif">
